...
parser.add_argument('--experiment_name', type=str, default='model_2x2-7x7(HCI)(decouple_conv)(mask_disp_adapt_0)(disp_smooth_loss)(decay5000_0.5)',
...
parser.add_argument('--epoch', type=int, default=50000, help='epoch number')
...
parser.add_argument('--decay_epoch', type=int, default=5000, help='every n epochs decay learning rate')
...
parser.add_argument('--disp_range', type=float, default=4, help='disparity range for plane sweep volume (psv)')
parser.add_argument('--num_planes', type=int, default=50, help='number of planes for psv')
